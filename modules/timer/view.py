"""
modules/timer/view.py

Timer module (stopwatch/countdown/Pomodoro built in its own phase). This is a real, functional placeholder widget for the app-shell
...
class TimerModule(BaseModule):
    ...
    def __init__(self, parent=None):
        ...
        label = QLabel("Timer module placeholder - full build in its own phase")
