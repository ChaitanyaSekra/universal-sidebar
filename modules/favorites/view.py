"""
modules/favorites/view.py

Favorites module (manual link list built in its own phase). This is a real, functional placeholder widget for the app-shell
...
class FavoritesModule(BaseModule):
    ...
    def __init__(self, parent=None):
        ...
        label = QLabel("Favorites module placeholder - full build in its own phase")
